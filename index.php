...
<head>
  ...
  <title>SlimTV - A Revolução dos Canais Online</title>

  <!-- CSS do Bootstrap -->
  <link rel="stylesheet" href="https://cdnjs.cloudflare.com/ajax/libs/bootstrap/5.3.0/css/bootstrap.min.css">
  
  <!-- Link do CSS do Font Awesome para o ícone do WhatsApp -->
  <link rel="stylesheet" href="https://cdnjs.cloudflare.com/ajax/libs/font-awesome/6.0.0-beta3/css/all.min.css">

  <style>
    /* Configurações de plano de fundo */
    body {
      background-image: url('https://slim.re/slim-m/img/novobg.png');
    ...
    <div class="container py-5 text-center">
      <div class="row d-flex align-items-center justify-content-center py-5">
        <div class="col-12 col-xl-10">
          <p class="fw-lighter" style="font-size: 10px;">SlimTV [01]</p>
          <h1 class="text-success">DESCUBRA O <span class="text-highlight">MAIOR</span> E MAIS <span class="text-highlight">LUCRATIVO</span> SISTEMA DE CANAIS ONLINE DO <span class="text-highlight">BRASIL</span></h1>
          <p class="lead mt-3">Entre para o mercado que mais cresce no país! Ofereça uma experiência de qualidade com acesso a centenas de canais. Fácil de vender, fácil de lucrar.</p>
        </div>
